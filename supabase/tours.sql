-- =============================================
-- Rain Forest Experiences CR — Tours Table
-- Run this in the Supabase SQL Editor
-- =============================================

-- Create enum for difficulty levels
CREATE TYPE rain_forest_exp_difficulty AS ENUM ('Easy', 'Moderate', 'Challenging');

-- Create tours table
CREATE TABLE IF NOT EXISTS rain_forest_exp_tours (
  ...
  schedule      TEXT NOT NULL DEFAULT 'Daily departures',
  difficulty    rain_forest_exp_difficulty NOT NULL DEFAULT 'Easy',
  min_people    INTEGER NOT NULL DEFAULT 2,
  max_group     TEXT NOT NULL DEFAULT 'Small groups',
  image         TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_rain_forest_exp_tours_slug ON rain_forest_exp_tours (slug);
CREATE INDEX IF NOT EXISTS idx_rain_forest_exp_tours_active ON rain_forest_exp_tours (active) WHERE active = true;

-- Enable RLS (Row Level Security)
ALTER TABLE rain_forest_exp_tours ENABLE ROW LEVEL SECURITY;

-- Public read-only policy (anyone can read active tours)
CREATE POLICY "Public can read rain_forest_exp_tours"
  ON rain_forest_exp_tours FOR SELECT
  USING (active = true);

-- =============================================
-- Seed data — all 8 tours
-- =============================================

INSERT INTO rain_forest_exp_tours (slug, title, short_title, description, long_description, price, duration, start_times, schedule, difficulty, min_people, max_group, image, gallery, includes, what_to_bring, highlights, note, sort_order) VALUES
...
(
  ...
  ARRAY['Certified naturalist guide', 'Small groups', 'Park entrance fee', 'Water & snacks', 'Optical equipment'],
  ARRAY['Insect repellent', 'Rain jacket', 'Comfortable clothing', 'Flashlight'],
  ARRAY['Spot the famous red-eyed tree frog', 'Observe nocturnal birds and sleeping toucans', 'See camouflaged insects and exotic spiders', 'Professional optical equipment provided', 'Expert naturalist guide shares deep knowledge'],
...
(
  ...
  ARRAY['Certified naturalist guide', 'Small groups', 'Park entrance fee', 'Water & snacks', 'Optical equipment'],
  ARRAY['Insect repellent', 'Rain jacket', 'Comfortable clothing'],
  ARRAY['Observe sloths in their natural habitat', 'Spot monkeys, toucans, and frogs', 'Professional spotting scopes & binoculars', 'Relaxed walk suitable for all ages', 'Small group for personalized experience'],
  'This tour requires a minimum of 2 adults.',
  2
),
...
(
  ...
  ARRAY['Certified naturalist guide', 'Small groups', 'Park entrance fee', 'Water & snacks', 'Optical equipment'],
  ARRAY['Insect repellent', 'Rain jacket', 'Comfortable clothing'],
  ARRAY['Walk across 6 hanging bridges at canopy level', '250+ hectares of pristine rainforest reserve', 'Spot monkeys, toucans, and exotic birds', 'Panoramic views of the forest canopy', 'Learn about the ecosystem from expert guide'],
  'This tour requires a minimum of 2 adults.',
  3
),
...
(
  ...
  ARRAY['Certified naturalist guide', 'Small groups', 'Park entrance fee', 'Water & snacks', 'Optical equipment'],
  ARRAY['Insect repellent', 'Rain jacket', 'Comfortable clothing'],
  ARRAY['Hike the historic 1968 lava flow', 'Learn 7,000 years of volcanic history', 'Spectacular views of the perfect cone', 'See how nature reclaims lava fields', 'Panoramic views of Lake Arenal'],
  'This tour requires a minimum of 2 adults.',
  4
),
...
(
  ...
  'Birdwatching Tour',
  'Birdwatching',
  E'Costa Rica is known for its great biodiversity, and with more than 900 bird species, it''s paradise for bird lovers. On a walk through the foothills of Arenal Volcano in a private reserve, you can observe a great number of birds including toucans, tanagers, warblers, trogons, motmots, and many more colorful species.',
  E'Costa Rica is one of the world''s premier birdwatching destinations, home to more than 900 species of birds — and the Arenal region is one of the richest birding areas in the entire country. This tour takes you through a private reserve on the foothills of the Arenal Volcano, where the diversity of habitats creates ideal conditions for an extraordinary variety of birdlife.\n\nYour certified naturalist guide is an experienced birder who knows exactly where and when to find the most spectacular species. Using professional optical equipment including high-powered spotting scopes and binoculars, you''ll get incredible views of toucans, tanagers, warblers, trogons, motmots, hummingbirds, and many other colorful tropical birds.\n\nWhether you''re a seasoned birder looking to add to your life list or a casual nature lover who simply enjoys the beauty of tropical birds, this tour offers an unforgettable experience. The early morning departure (5:15 AM) takes advantage of peak bird activity, while the afternoon option offers a different set of species to observe.',
  75,
  '4 hours',
  ARRAY['5:15 AM', '2:30 PM'],
  'Daily departures',
  'Easy',
  2,
  'Small groups',
  ...
  ARRAY['Certified naturalist guide', 'Small groups', 'Park entrance fee', 'Water & snacks', 'Optical equipment'],
  ARRAY['Insect repellent', 'Rain jacket', 'Comfortable clothing'],
  ARRAY['900+ bird species in Costa Rica', 'Spot toucans, trogons, motmots & tanagers', 'Professional spotting scopes provided', 'Private reserve on Arenal Volcano foothills', 'Expert birding guide with deep knowledge'],
  'This tour requires a minimum of 2 adults.',
  5
),
...
(
  ...
  ARRAY['Certified naturalist guide', 'Small groups', 'National Park entrance fee', 'Water & snacks', 'Optical equipment'],
  ARRAY['Insect repellent', 'Rain jacket', 'Comfortable clothing'],
  ARRAY['See the magical sky-blue Celeste River', 'Visit the stunning Celeste Waterfall', 'Discover Los Teñideros where water changes color', '6km hike through pristine rainforest', 'Explore Tenorio Volcano National Park'],
  'This tour requires a minimum of 2 adults.',
  6
),
...
(
  ...
  ARRAY['Certified naturalist guide', 'Traditional Costa Rican lunch', 'Small groups', 'All park entrance fees', 'Water & snacks', 'Optical equipment'],
  ARRAY['Insect repellent', 'Rain jacket', 'Comfortable clothing'],
  ARRAY['3 top attractions in 1 day', 'Hike the 1968 Arenal lava flow', 'Swim at La Fortuna Waterfall', 'Cross hanging bridges at canopy level', 'Traditional Costa Rican lunch included'],
  'This tour requires a minimum of 2 adults.',
  7
),

-- 8. Costa Rican Family Visit
(
  'costa-rican-family-visit',
  'Visit a Costa Rican Family',
  'Family Visit',
